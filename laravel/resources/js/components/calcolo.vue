                                ...
                                <div class="item">
                                    <div class="testimonial text-center py-4">
                                        <div class="input-container">
                                            ...
                                            <ul class="nav nav-tabs round justify-content-center align-items-center"
                                                role="tablist">
                                                <li role="presentation" v-for="combustibile in getCombustibili"
                                                    :key="combustibile.id" class="my-1">
                                                    <a href="#" v-on:click="setCombustibile(combustibile.id)"
                                                        aria-controls="all-faqs" role="tab" data-toggle="tab"
                                                        class="d-flex align-items-center">
                                                        <img :src="'/img/icons-png/' + combustibile.immagine" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                            <h4 class="mb-4" v-if="getCombustibileName != ''" >{{ getCombustibileName }}</h4>
                                        </div>
                                        <div class="input-container">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="seo">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-2">qui ci va un testo descrittovp di circa 2 o 3 righe</p>
                                        <a class="button mt-3" @click="goToConfronto()">Vai alla pagina del confronto</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            this.combustibili.forEach(element => {
                if (element.id == id) {
                    ...
                    if (element.tecnologia != '') {
                        ...
                        this.combustibileName = this.combustibileName + ' - ' + tecnologia;
                    }
                    return;
                }
            });
